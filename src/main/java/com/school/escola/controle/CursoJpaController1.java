...
import com.school.escola.controle.exceptions.NonexistentEntityException;
import com.school.escola.controle.exceptions.RollbackFailureException;
import com.school.escola.modelo.Curso;
 ...
 * @author Cirim
 */
public class CursoJpaController1 implements Serializable {

    public CursoJpaController1(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
